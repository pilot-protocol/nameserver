...
Thanks for your interest in contributing to `nameserver` — Pilot Protocol nameserver plugin — DNS-like hostname resolution over the overlay (port 53).

## Quick start

```bash
git clone https://github.com/pilot-protocol/nameserver.git
cd nameserver
go test -race ./...
```
